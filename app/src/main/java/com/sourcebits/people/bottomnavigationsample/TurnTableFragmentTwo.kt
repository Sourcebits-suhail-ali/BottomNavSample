 ...
 */
class TurnTableFragmentTwo : Fragment() {
...
var text:String = ""
    ...
    companion object {
        fun newInstance(text1: String): TurnTableFragmentTwo =
            TurnTableFragmentTwo().apply {
                text =  text1
            }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        setTextView(text)
            ...
            setTextView(TurnTableFragmentTwo.javaClass.simpleName)
    }
